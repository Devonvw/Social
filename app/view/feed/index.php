    ...
    <div class="min-h-screen">
        ...
        <div class="flex justify-center mt-32">
            <div class="w-full px-2 sm:px-0 sm:max-w-xl">
                ...
                <div class="bg-teal-600/10 rounded-lg overflow-hidden relative mb-12">
                    ...
                    <img class="h-80 w-full object-center object-cover" src="<?= $item->image_url ?>">
                    </img>
                    <div class="p-4 relative">
                        <div class="flex items-center justify-center absolute top-2 right-2">
                            <p class="text-teal-800"><?= $item->likes ?></p><button id="<?= $item->id ?>"
                                class="w-6 h-6 " onclick="likeUnlikePost(this)"><svg xmlns="http://www.w3.org/2000/svg"

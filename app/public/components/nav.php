<nav class="fixed top-0 w-full z-50" style="backdrop-filter: blur(20px);">
    <div class="flex flex-row justify-between px-4 py-6">
        <a href="../index.php">
            <h1 class="text-teal-800 font-black uppercase text-4xl leading-tight tracking-tight">Tosti</h1>
        </a>
        <div><?php if (!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true) : ?><a href="../login.php"
